...
const memberDirectory = {
  ...
  page: { number: 0, size: 8, totalElements: 3, totalPages: 1 },
  counts: {
    total: 3,
    active: 3,
    inactive: 0,
    byAcademicStatus: { ENROLLED: 3 },
    byTrack: { FRONTEND: 1, BACKEND: 1, DESIGN: 1 },
    byMemberType: { REGULAR: 1, MENTOR: 1, BEGINNER: 1 },
  },
};
